...
\input{Resultados/Questionario/Tabelas/ttest_questionnaires}

The Table \ref{tab:questionnaire_average} presents these averages by each participant on each scenes.

\input{Resultados/Questionario/Tabelas/questionnaire_average}
...
\begin{figure}[!htb]
    \centering
    \resizebox{0.8\linewidth}{!}{
    \input{Resultados/Questionario/Figuras/boxplot_questionnaire.pgf}    
    }
